...
return y.vM},"call$2","fv",4,0,null,6,195]}],["","file:///home/ubuntu/src/github.com/oadam/straight-race/web/tire.dart",,F,{
"^":"",
Iq:[function(){var z,y
z=new F.qQ(null,null)
z.mO()
y=new O.Xj(0,0.00001)
N.u8("no error at 0 speed",new F.em(z))
N.u8("grip at high longitudinal speed",new F.Lb(z,y))
N.u8("grip at high lateral speed",new F.QA(z,y))
N.u8("grip when accelerating",new F.Cv(z,y))
N.u8("grip when breaking",new F.ed(z,y))
N.u8("accelerating when going backward",new F.wa(z,y))},"call$0","eE",0,0,196],
qQ:{
"^":"a;o3,o9",
uU:function(a){if(a<1)return 3*a/1
...
z[0]=0
z[1]=-50
z=this.d.OJ(new T.z3(z),0,2500).Ev
...
z[0]=50
z[1]=0
z=this.f.OJ(new T.z3(z),55,2500).Ev
O.CR(z[0],new O.FH(0,!1,!1,!0,"a value greater than",!0),null,"x response",!1)
O.CR(z[1],this.UI,null,"y response",!1)},"call$0",null,0,0,null,"call"],
$isEH:true},
ed:{
"^":"Tp:196;bK,Gq",
call$0:[function(){var z=new Float32Array(2)
z[0]=50
z[1]=0
z=this.bK.OJ(new T.z3(z),45,2500).Ev
O.CR(z[0],new O.FH(0,!1,!0,!1,"a value less than",!0),null,"x response",!1)
...
z=this.FR
y=H.N7()
x=H.fH(y,[y,y,y,y,y,y]).Wf(z)
if(x)return this.gn9()
x=H.fH(y,[y,y,y,y,y]).Wf(z)
if(x)return this.gOj()
x=H.fH(y,[y,y,y,y]).Wf(z)
...
z=new Float32Array(4)
y=this.Ev
z[0]=C.CD.W(y[0],b.gEv().t(0,0))
z[1]=C.CD.W(y[1],b.gEv().t(0,1))
z[2]=C.CD.W(y[2],b.gEv().t(0,2))
z[3]=C.CD.W(y[3],b.gEv().t(0,3))
return new T.GR(z)},
...
x[1]=t*w+z*u
return b},
OY:function(a){return this.RE(a,null)}},
z3:{
"^":"a;Ev<",
Hu:function(a){var z,y
z=this.Ev
